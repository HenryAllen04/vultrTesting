...
echo "   curl -fsSL https://get.docker.com -o get-docker.sh && sh get-docker.sh && docker login lhr.vultrcr.com && docker run -d -p 80:3000 --name lecommit-app --restart unless-stopped lhr.vultrcr.com/lecommit-webapp:latest"
echo ""
